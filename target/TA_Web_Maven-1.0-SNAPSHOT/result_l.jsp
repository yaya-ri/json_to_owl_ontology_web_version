                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="profile.jsp">Profil</a></li>
                        </ul>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class=" col-md-9 col-lg-9 "> 
                                    ...
                                    %>
                                    <textarea class="form-control" style="font-size:14px" name="text" rows="12" cols="90">
                                        <%= readResult%>
                                    </textarea>
                                    <br>
                                    <form method="post">
                                        <button class="btn btn-info" type="submit" formaction="ProsesAddBookmark">Bookmark</button>
                                        <input type="hidden" name="fileName" value="<%= Session.getFileName()%>">
                                        <button class="btn btn-primary" type="submit" formaction="DownloadFile">Unduh File</button>
